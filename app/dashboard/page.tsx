            ...
            <div>
                ...
                <Row gutter={[16, 16]} style={{ marginBottom: "24px" }}>
                    <Col xs={24} sm={12} lg={6}>
                        <MetricCard title="Active Devices" value={stats?.activeDevices || 0} prefix={<MobileOutlined />} suffix={`/ ${stats?.totalDevices || 0}`} loading={loading} />
                    </Col>
                    <Col xs={24} sm={12} lg={6}>
                        <MetricCard title="Today's Readings" value={stats?.todayReadings || 0} prefix={<LineChartOutlined />} loading={loading} />
                    </Col>
                    <Col xs={24} sm={12} lg={6}>
                        <MetricCard title="Average Heart Rate" value={stats?.averageHeartRate || 0} prefix={<HeartOutlined />} suffix="BPM" loading={loading} />
                    </Col>
                    <Col xs={24} sm={12} lg={6}>
                        <MetricCard title="Abnormal Alerts" value={stats?.abnormalAlerts || 0} prefix={<AlertOutlined />} valueStyle={{ color: "#ff4d4f" }} loading={loading} />
                    </Col>
                </Row>

                <Row gutter={[16, 16]} style={{ marginBottom: "24px" }}>
                    <Col xs={24} lg={16}>
                        <Card title="Recent Heart Rate Chart" loading={loading}>
